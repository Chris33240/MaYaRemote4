...
// IR protocols
[[deprecated("Original code from Omote. Use the new one instead. 'IRprotocols2'")]] enum IRprotocols {
  IR_PROTOCOL_GC = 0,
  IR_PROTOCOL_NEC = 1,
