...
#define GPIO_IR_LED_INVERTED        false   // Init IR_SEND_PIN : HIGH = (LED Off) if inverted = true
#define GPIO_CAPTURE_BUTTON         21      // Capture button
#define GPIO_WAKEUP_BUTTON          21      // Wake-up button
...
#define GPIO_IR_LED_INVERTED        false   // Init IR_SEND_PIN : HIGH = (LED Off) if inverted = true
#define GPIO_CAPTURE_BUTTON         14      // GPIO14 Capture button
#define GPIO_WAKEUP_BUTTON          14      // GPIO14 Wake-up button
...
#define GPIO_IR_LED_INVERTED        false   // Init IR_SEND_PIN : HIGH = (LED Off) if inverted = true
#define GPIO_CAPTURE_BUTTON         3       // GPIO3 Capture button
#define GPIO_WAKEUP_BUTTON          3       // GPIO3 Wake-up button
